...
function searchBookmark() {
    for (
        var e,
            t = document.getElementById("searchbookmark").value.toUpperCase(),
            a = document
        ...
        -1 <
        ((e = a[s].getElementsByTagName("a")[0]).textContent || e.innerText)
            .toUpperCase()
            .indexOf(t)
            ? (a[s].style.display = "")
...
function themeColor(e) {
    ...
    t && (document.getElementById(t).checked = !0),
        document.querySelectorAll(".theme-color").forEach(function (i) {
            var e,
                t,
                a = document.querySelector("input[name=bgcolor-radio]:checked");
            a &&
                ((a = a.id),
                ...
                (rgbColorSecondary = t.substring(
                    t.indexOf("b") + 2,
                    t.indexOf(")")
                )),
                (rgbColorPrimary = t.substring(
                    t.lastIndexOf("(") + 1,
                    t.lastIndexOf(")") - 1
                ))),
                    ...
                    s &&
                        ...
                        (t = document.getElementsByClassName(s)) &&
                            ((a = window
                                ...
                                .getPropertyValue("background-image")),
                            (rgbColorSecondary = a.substring(
                                a.indexOf("b") + 2,
                                a.indexOf(")")
                            )),
                            (rgbColorPrimary = a.substring(
                                a.lastIndexOf("(") + 1,
                                a.lastIndexOf(")") - 1
                            )),
        ...
        document.querySelectorAll(".colorpicker-primary").forEach(function () {
            var e = localStorage.getItem("colorPrimary")
        ...
        document
            .querySelectorAll(".colorpicker-secondary")
            .forEach(function () {
                var e = localStorage.getItem("colorSecondary")
                        ? "rgba(" +
                          localStorage.getItem("colorSecondary") +
                          ",1)"
                        : "#b966c1",
                    i = Pickr.create({
...
!(function () {
        ...
        null !== e
            ...
            : (t[0].favorites.forEach(function (e, t) {
                  ...
                  document.getElementById("favourite-users").innerHTML +=
                      ...
                      a +
                      '                          </div>                          <div class="overflow-hidden me-2">                              <p class="text-truncate chat-username mb-0">' +
                      e.name +
                      '</p>                              <p class="text-truncate text-muted fs-13 mb-0">' +
                      e.lastmessage +
                      "</p>                          </div>                          " +
                      s +
                      "                      </div>                  </a>              </li>";
              ...
              t[0].channels.forEach(function (e, t) {
                  ...
                  document.getElementById("channelList").innerHTML +=
                      ...
                      '" data-name="channel">                ' +
                      i +
                      '                     <div class="d-flex align-items-center">                        <div class="flex-shrink-0 me-2">                            <div class="chat-user-img online align-self-center">                            ' +
                      a +
                      '                            </div>                        </div>                        <div class="flex-grow-1 overflow-hidden">                            <h6 class="text-truncate mb-0">' +
                      e.name +
                      '</h6>                            <p class="text-truncate text-muted fs-13 mb-0">' +
                      e.lastmessage +
                      "</p>                        </div>                        <div>" +
                      s +
                      "</div>                    </div>                </a>            </li>";
            ...
            document.querySelectorAll("#channelList li").forEach(function (i) {
                i.addEventListener("click", function (e) {
                    ...
                    null !== s
                        ? (document
                              .querySelector(
                                  "#channel-chat .user-own-img .avatar-sm"
                              )
                              .setAttribute("src", s),
                          document
                              .querySelector(
                ...
                : ((callList = t),
                  callList.forEach(function (e, t) {
                      ...
                      document.getElementById("callList").innerHTML +=
                          ...
                          e.name +
                          '</p>                <div class="text-muted fs-12 text-truncate"><i class="' +
                          e.callArrowType +
                          '"></i> ' +
                          e.dateTime +
                          '</div>            </div>            <div class="flex-shrink-0 ms-3">                <div class="d-flex align-items-center gap-3">                    <div>                        <h5 class="mb-0 fs-12 text-muted">' +
                          e.callTime +
                          "</h5>                    </div>                    <div>                       " +
                          a +
                          "                    </div>                </div>            </div>        </div>      </li>";
                ...
                : ((u = t).sort(function (e, t) {
                  ...
                  u.forEach(function (e, t) {
                      ...
                      i =
                          ...
                          a +
                          '                      </div>                  </div>                  <div class="flex-grow-1">                      <h5 class="fs-14 m-0" >' +
                          e.name +
    ...
    var l = document.querySelector("#chatinput-form"),
        y = document.querySelector("#chat-input"),
    ...
    document
        ...
        .addEventListener("change", function () {
            ...
            (n = document.querySelector("#audiofile-input").files[0]),
                (k = URL.createObjectURL(n));
        ...
        .addEventListener("change", function () {
            ...
            (p = document.querySelector("#attachedfile-input").files[0]),
                ...
                fr.addEventListener(
                    ...
                    function () {
                        var e = p.name,
                            t = Math.round(p.size / 1e6).toFixed(2);
                        (a.innerHTML =
                            '<div class="card p-2 border attchedfile_pre d-inline-block position-relative">            <div class="d-flex align-items-center">                <div class="flex-shrink-0 avatar-xs ms-1 me-3">                    <div class="avatar-title bg-soft-primary text-primary rounded-circle">                        <i class="ri-attachment-2"></i>                    </div>                </div>                <div class="flex-grow-1 overflow-hidden">                <a href="" id="a"></a>                    <h5 class="fs-14 text-truncate mb-1">' +
                            e +
    ...
    l &&
        l.addEventListener("submit", function (e) {
            ...
            var t,
                ...
                c = g,
                d = y.value,
                u = document.querySelector(".image_pre"),
                m = document.querySelector(".attchedfile_pre"),
                p = document.querySelector(".audiofile_pre"),
                      ...
                      ? (f.classList.remove("show"),
                        ...
                        a.forEach(function (e) {
                            i +=
                                ...
                                e +
                                '" alt="" class="rounded border img-thumbnail" width="200" />            </a>          </div>          <div class="message-img-link">            <ul class="list-inline mb-0">              <li class="list-inline-item dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    <i class="bx bx-dots-horizontal-rounded"></i>                </a>          <div class="dropdown-menu">            <a class="dropdown-item d-flex align-items-center justify-content-between" href="' +
                                e +
                        ...
                        null != a &&
                            (s.insertAdjacentHTML(
                                ...
                                '<li class="chat-list right" id="chat-list-' +
                                    S +
                                    '" >        <div class="conversation-list">            <div class="user-chat-content">                <div class="ctext-wrap">                        <div class="message-img mb-0">' +
                                    i +
                                    '                    </div>                    </div>                  <div class="conversation-name">                    <small class="text-muted time">' +
                                    x() +
                            ...
                            b
                                ...
                                .forEach(function (e) {
                                    e.querySelectorAll(".delete-image").forEach(
                                        function (e) {
                                            e.addEventListener(
                                                "click",
                                                function () {
                                                    1 ==
                                                    e.closest(".message-img")
                                                        .childElementCount
                                                        ? e
                                                              .closest(
                                                                  ".chat-list"
                            ...
                            B.querySelectorAll(".chat-list").forEach(function (
                                e
                            ) {
                                e.querySelectorAll(".delete-image").forEach(
                                    function (e) {
                        ...
                        (function (e, t, a) {
                            ...
                            null != t &&
                                s.insertAdjacentHTML(
                                    ...
                                    '<li class="chat-list right" id="chat-list-' +
                                        S +
                                        '" >          <div class="conversation-list">              <div class="user-chat-content">                  <div class="ctext-wrap">                      <div class="ctext-wrap-content">                          <div class="p-3 border rounded-3">                              <div class="d-flex align-items-center attached-file">                                  <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">                                      <div class="avatar-title bg-soft-light rounded-circle fs-20"><i class="ri-attachment-2"></i></div>                                  </div>                                  <div class="flex-grow-1 overflow-hidden">                                      <div class="text-start">                                          <h5 class="fs-14 text-white mb-1">' +
                                        t +
                                        '</h5>                                          <p class="text-white-50 text-truncate fs-13 mb-0">' +
                                        a +
                                        'mb</p>                                      </div>                                  </div>                                  <div class="flex-shrink-0 ms-4">                                      <div class="d-flex gap-2 fs-20 d-flex align-items-start">                                          <div>                                              <a href="#" class="text-white-50 download-file" data-id="' +
                                        A +
                                        '"> <i class="bx bxs-download"></i> </a>                                          </div>                                      </div>                                  </div>                              </div>                          </div>                      </div>                      <div class="align-self-start message-box-drop d-flex">                      <div class="dropdown">                        <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                          <i class="ri-emotion-happy-line"></i>                        </a>                        <div class="dropdown-menu emoji-dropdown-menu">                          <div class="hstack align-items-center gap-2 px-2 fs-25">                            <a href="javascript:void(0);">💛</a>                            <a href="javascript:void(0);">🤣</a>                            <a href="javascript:void(0);">😜</a>                            <a href="javascript:void(0);">😘</a>                            <a href="javascript:void(0);">😍</a>                            <div class="avatar-xs">                            <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                            </div>                          </div>                        </div>                      </div>                      <div class="dropdown">                          <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ri-more-2-fill"></i> </a>                          <div class="dropdown-menu">            <a class="dropdown-item d-flex align-items-center justify-content-between" href="' +
                                        t +
                                        '" download>Download <i class="bx bx-download ms-2 text-muted"></i></a>            <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>            <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>            <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                          <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" id="delete-item-' +
                                        S +
                                        '" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                      </div>                    </div>                    </div>                  </div>                <div class="conversation-name">                    <small class="text-muted time">' +
                                        x() +
                        ...
                        (function (e, t) {
                            ...
                            null != t &&
                                a.insertAdjacentHTML(
                                    ...
                                    '<li class="chat-list right" id="chat-list-' +
                                        S +
                                        '" >          <div class="conversation-list">              <div class="user-chat-content">                  <div class="ctext-wrap">                  <div class="audio-file-elem">                              <audio controls>                                  <source src="' +
                                        k +
                                        '" type="audio/mpeg">                              </audio>                          </div>                      <div class="align-self-start message-box-drop d-flex">                      <div class="dropdown">                        <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                          <i class="ri-emotion-happy-line"></i>                        </a>                        <div class="dropdown-menu emoji-dropdown-menu">                          <div class="hstack align-items-center gap-2 px-2 fs-25">                            <a href="javascript:void(0);">💛</a>                            <a href="javascript:void(0);">🤣</a>                            <a href="javascript:void(0);">😜</a>                            <a href="javascript:void(0);">😘</a>                            <a href="javascript:void(0);">😍</a>                            <div class="avatar-xs">                            <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                            </div>                          </div>                        </div>                      </div>                        <div class="dropdown">                            <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="ri-more-2-fill"></i> </a>                            <div class="dropdown-menu">            <a class="dropdown-item d-flex align-items-center justify-content-between" href="' +
                                        t +
                                        '" download>Download <i class="bx bx-download ms-2 text-muted"></i></a>            <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>            <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>            <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                                <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" id="delete-item-' +
                                        S +
                                        '" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                            </div>                        </div>                      </div>                      </div>                      <div class="conversation-name">                          <small class="text-muted time">' +
                      ...
                      null != t &&
                          (i.insertAdjacentHTML(
                              ...
                              '<li class="chat-list right" id="chat-list-' +
                                  ...
                                  '</h5>                            <p class="mb-0">' +
                                  s +
                                  '</p>                        </div>                        <div class="flex-shrink-0">                            <button type="button" class="btn btn-sm btn-link mt-n2 me-n3 fs-18">                            </button>                        </div>                    </div>                                <p class="mb-0 ctext-content mt-1">                                    ' +
                                  t +
                                  '                                </p>                            </div>                            <div class="align-self-start message-box-drop d-flex">                            <div class="dropdown">                              <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                <i class="ri-emotion-happy-line"></i>                              </a>                              <div class="dropdown-menu emoji-dropdown-menu">                                <div class="hstack align-items-center gap-2 px-2 fs-25">                                  <a href="javascript:void(0);">💛</a>                                  <a href="javascript:void(0);">🤣</a>                                  <a href="javascript:void(0);">😜</a>                                  <a href="javascript:void(0);">😘</a>                                  <a href="javascript:void(0);">😍</a>                                  <div class="avatar-xs">                                    <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                                  </div>                                </div>                              </div>                            </div>                              <div class="dropdown">                                  <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                      <i class="ri-more-2-fill"></i>                                  </a>                                  <div class="dropdown-menu">                                      <a class="dropdown-item d-flex align-items-center justify-content-between reply-message" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>                                      <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>                                      <a class="dropdown-item d-flex align-items-center justify-content-between copy-message" href="#" id="copy-message-' +
                                  S +
            ...
            .addEventListener("click", function (e) {
                document
                    ...
                    .forEach(function (e) {
                        ...
                        e.disabled
                            ? (t.classList.replace("bxs-pencil", "bxs-save"),
                              (e.disabled = !1))
                            : (t.classList.replace("bxs-save", "bxs-pencil"),
                              (e.disabled = !0));
                    });
            });
    for (
        var f = document.getElementsByClassName("favourite-btn"), M = 0;
        M < f.length;
        M++
    ) {
        var T = f[M];
    ...
    new FgEmojiPicker({
        ...
        position: ["top", "right"],
        preFetch: !0,
        dir: "public/assets/js/dir/json",
        insertInto: document.querySelector(".chat-input"),
    });
    function I(e, t, a, s, i, l, o) {
        ...
        if (null != t)
            ...
            for (
                r += '<div class="message-img mb-0">', M = 0;
                M < a.length;
                M++
            )
                r +=
                    ...
                    '">                <img src="' +
                    a[M] +
                    '" alt="" class="rounded border img-thumbnail">              </a>            </div>            <div class="message-img-link">              <ul class="list-inline mb-0">                <li class="list-inline-item dropdown">                  <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                      <i class="bx bx-dots-horizontal-rounded"></i>                  </a>                <div class="dropdown-menu">                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="' +
                    a[M] +
            ...
            0 < s.length
                ? (r +=
                      '<div class="ctext-wrap-content">            <div class="p-3 border rounded-3">            <div class="d-flex align-items-center attached-file">                <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">                    <div class="avatar-title bg-soft-light rounded-circle fs-20">                        <i class="ri-attachment-2"></i>                    </div>                </div>                <div class="flex-grow-1 overflow-hidden">                    <div class="text-start">                        <h5 class="fs-14 text-white mb-1">design-phase-1-approved.pdf</h5>                        <p class="text-white-50 text-truncate fs-13 mb-0">12.5 MB</p>                    </div>                </div>                <div class="flex-shrink-0 ms-4">                    <div class="d-flex gap-2 fs-20 d-flex align-items-start">                        <div>                            <a href="#" class="text-white-50">                                <i class="bx bxs-download"></i>                            </a>                        </div>                    </div>                </div>             </div>            </div>            </div>            <div class="emoji-icon">                <a class="dropdown-toggle" href="#">👍</a>            </div>            <div class="align-self-start message-box-drop d-flex">              <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                  <i class="ri-emotion-happy-line"></i>                </a>                <div class="dropdown-menu emoji-dropdown-menu">                  <div class="hstack align-items-center gap-2 px-2 fs-25">                    <a href="javascript:void(0);">💛</a>                    <a href="javascript:void(0);">🤣</a>                    <a href="javascript:void(0);">😜</a>                    <a href="javascript:void(0);">😘</a>                    <a href="javascript:void(0);">😍</a>                    <div class="avatar-xs">                    <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                    </div>                  </div>                </div>              </div>              <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    <i class="ri-more-2-fill"></i>                </a>                <div class="dropdown-menu">                  <a class="dropdown-item d-flex align-items-center justify-content-between"  href="' +
                      s +
                ...
                : i && 0 < i.length
                ? (r +=
                      '<div class="audio-file-elem">                              <audio controls>                                  <source src="' +
                      i +
                      '" type="audio/mpeg">                              </audio>                          </div>                  <div class="align-self-start message-box-drop d-flex">              <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                  <i class="ri-emotion-happy-line"></i>                </a>                <div class="dropdown-menu emoji-dropdown-menu">                  <div class="hstack align-items-center gap-2 px-2 fs-25">                    <a href="javascript:void(0);">💛</a>                    <a href="javascript:void(0);">🤣</a>                    <a href="javascript:void(0);">😜</a>                    <a href="javascript:void(0);">😘</a>                    <a href="javascript:void(0);">😍</a>                    <div class="avatar-xs">                    <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                    </div>                  </div>                </div>              </div>              <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    <i class="ri-more-2-fill"></i>                </a>                <div class="dropdown-menu">                  <a class="dropdown-item d-flex align-items-center justify-content-between"  href="' +
                      i +
                      '" download>Download <i class="bx bx-download ms-2 text-muted"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                </div>              </div>          </div>')
                : l &&
                  ...
                  (r +=
                      '<div>        <iframe src="' +
                      l +
                      '" title="YouTube video" class="w-100 rounded" autoplay allowfullscreen></iframe>      </div>                  <div class="align-self-start message-box-drop d-flex">              <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                  <i class="ri-emotion-happy-line"></i>                </a>                <div class="dropdown-menu emoji-dropdown-menu">                  <div class="hstack align-items-center gap-2 px-2 fs-25">                    <a href="javascript:void(0);">💛</a>                    <a href="javascript:void(0);">🤣</a>                    <a href="javascript:void(0);">😜</a>                    <a href="javascript:void(0);">😘</a>                    <a href="javascript:void(0);">😍</a>                    <div class="avatar-xs">                    <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                    </div>                  </div>                </div>              </div>              <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    <i class="ri-more-2-fill"></i>                </a>                <div class="dropdown-menu">                  <a class="dropdown-item d-flex align-items-center justify-content-between"  href="' +
                      l +
                      '" download>Download <i class="bx bx-download ms-2 text-muted"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                  <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                </div>              </div>          </div>');
        return (
            !0 === o &&
                (r +=
                    '<div class="align-self-start message-box-drop d-flex">            <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                  <i class="ri-emotion-happy-line"></i>                </a>                <div class="dropdown-menu emoji-dropdown-menu">                  <div class="hstack align-items-center gap-2 px-2 fs-25">                    <a href="javascript:void(0);">💛</a>                    <a href="javascript:void(0);">🤣</a>                    <a href="javascript:void(0);">😜</a>                    <a href="javascript:void(0);">😘</a>                    <a href="javascript:void(0);">😍</a>                    <div class="avatar-xs">                    <a href="javascript:void(0);" class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a>                    </div>                  </div>                </div>            </div>            <div class="dropdown">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    <i class="ri-more-2-fill"></i>                </a>                <div class="dropdown-menu">                    <a class="dropdown-item d-flex align-items-center justify-content-between reply-message" href="#" id="reply-message-' +
                    S +
    ...
    function H(e) {
        ...
        (t = e),
            (a = function (e, t) {
                ...
                null !== e
                    ? console.log("Something went wrong: " + e)
                    : ((l = "users" == d ? t[0].chats : t[0].channel_chat),
                    ...
                    (a = b.querySelectorAll(".reply-message")),
                    ...
                    (n = document.querySelector(".replyCard")),
